...
<html>
  <head>
    <meta charset="UTF-8" />
    <title><spring:message code="label.addChildHeader" /></title>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/style.css"/>
  </head>
  <body>
  <jsp:useBean id="date" class="java.util.Date"/>
    <h1><spring:message code="label.addChildHeader" /></h1>
    <div>
      <table border="1">
        <tr>
        ...
        <tr>
          <td>${child.id}</td>
          <td><a href="${pageContext.request.contextPath}/${locale}/web-api/person/${personId}/add-child/${child.id}">${child.name}</a></td>
          <td><c:choose>
